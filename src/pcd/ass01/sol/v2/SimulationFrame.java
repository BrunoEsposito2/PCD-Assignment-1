...
public class SimulationFrame extends JFrame {
    ...
    public static class VisualiserPanel extends JPanel {
        ...
        public void paint(Graphics g){
    		...
    		if (sim != null) {
	    		int nBodies = 0;
	    		// System.out.println("drawing bodies started");

	    		for (Area area: sim.getAreas()) {
	        		area.getBodies().forEach( b -> {
	    	        	Position p = b.getPos();
	        		...
	        		nBodies += area.getBodies().size();
	    		}
	    		String time = String.format("%.2f", sim.getTime());
	    		g2.drawString("Bodies: " + nBodies + " - vt: " + time + " - nIter: " + sim.getNIter(), 2, 20);
